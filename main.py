...
flight_manager = FlightManager(amadeus_access_token, sheety, notification_manager)
rows_with_no_code = 0
for row in sheety_data["prices"]:
    rows_with_no_code += flight_manager.search_save_iata_code(row)
    flight_manager.compare_prices(row)
    print()
